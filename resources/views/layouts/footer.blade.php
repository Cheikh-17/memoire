 <!-- Footer Start -->
 <div class="container-fluid bg-dark text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s" style="background-color: #026952 !important;">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="#soins">Soins Dentaires</a>
                <a class="btn btn-link" href="#implan">Implantologie</a>
                <a class="btn btn-link" href="#ortho">Orthodontie</a>
                <a class="btn btn-link" href="#esthe">Esthétique Dentaire</a>
                <a class="btn btn-link" href="#parod">Parodontologie</a>
            </div>
            <div class="col-lg-3 col-md-6">

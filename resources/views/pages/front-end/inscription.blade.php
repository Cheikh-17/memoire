      ...
      <div class="auth-form">
        <div class="card my-5 mx-3">
          <div class="card-body">
            ...
            <p class="mb-3">Already have an Account? <a href="../pages/login-v2.html" class="link-primary">Log in</a></p>
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
...
Since there is no selected code, I will provide a general improvement to the HTML structure and code organization. Here's an example of how the code can be improved:
